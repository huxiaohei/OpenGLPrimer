...
int main() {
	...
	unsigned int texture = loadTexture("shibaluohan.png");
	unsigned int texture1 = loadTexture("shibaluohan1.png");
	unsigned int texture2 = loadTexture("shibaluohan2.png");
	...
	while (!window->shouldClose()) {
		...
		shader->setUniform("dir", 1);
		shader->setUniform("light", 0);
